...
impl OutputRenderer for WaveRenderer {
    fn get_header(&self) -> Option<Vec<u8>> {
        ...
        buf.write(&(fsize as u32).to_le_bytes()).ok()?;
        ...
        buf.write(&16_u32.to_le_bytes()).ok()?;
        ...
        buf.write(&(byte_rate as u32).to_le_bytes()).ok()?;
        ...
        buf.write(&(block_align as u16).to_le_bytes()).ok()?;
        ...
        buf.write(&(bits_per_sample as u16).to_le_bytes()).ok()?;
        ...
        buf.write(&(buflen as u32).to_le_bytes()).ok()?;
